...
/**
 * Creates a table called "weather" out of this class. The date is used an index
 * so that its uniqueness is ensured
 */
@Entity(tableName = "weather", indices = {@Index(value = {"date"}, unique = true)})
public class WeatherEntry {
    /**
     * makes id the primary key,
     * the autoGenerate attrib is set to true so that Room generates the key
     */
