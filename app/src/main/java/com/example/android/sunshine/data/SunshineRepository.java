...
public class SunshineRepository {
    ...
    /**
     * This method gets the data from the WeatherDao
     * and returns that data to DetailActivityViewModel
     * @param date
     * @return
     */
    public LiveData<WeatherEntry> getWeatherByDate(Date date) {
        // ensure that every time you getWeatherByDate(),
        // the data initialization (fetch)is triggered
        initializeData();
        return mWeatherDao.getWeatherByDate(date);
    }

    /**
     * Gets a list of weather forecasts from the WeatherDao
     * and returns that data to the MainActivityViewModel
     * @return
     */
    public LiveData<List<ListViewWeatherEntry>> getLatestWeatherForecasts() {
        initializeData();
        return mWeatherDao.getWeatherAfterDate(SunshineDateUtils.getNormalizedUtcDateForToday());
    }
